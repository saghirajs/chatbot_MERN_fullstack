        ...
        <CCardBody>
          <CRow>
            <CCol sm="5">
              ...
              <div className="small text-muted">Mars 2021</div>
            </CCol>
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <div className="progress-group mb-4" style={{paddingTop: '15%'}}>
                  ...
                  <div className="progress-group mb-5">
                    ...
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="warning" value="57" />
                    </div>
                  </div>
